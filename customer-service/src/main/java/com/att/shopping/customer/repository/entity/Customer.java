package com.att.shopping.customer.repository.entity;
...
public class Customer implements Serializable{
    ...
    @NotEmpty(message = "El número de documento no puede quedar vacío")
    ...
    @NotEmpty(message = "El correo no puede quedar vacío")
    ...
    @NotNull(message = "La región no puede quedar vacia")
